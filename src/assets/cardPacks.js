...
export const allClassOneCards = {
    ...
    priest: [
        ...
        },
        {
            ...
            action: 'Active - Spell',
            description: 'Target one ally within 5 yards. For a number of rounds equal to your Will, you and that ally deal an extra 1d3 divine damage with your attacks.',
            level: 1
        },
        {
...
export const allClassTwoCards = {
    ...
    bard: [
        ...
        },
        {
            ...
            action: 'Active',
            description: 'For 1 minute, You and all allies within 6 yards that can hear you are immune to the frightened condition and have minor advantage on “Resist Manipulation” rolls. Keep the beat: Move > Attack | Attack > Action => Damage Resistance 3 for all creatures affected by the spell',
            level: 3
        },
        {
            cardName:'The Grand Illusion',
            action: 'Active - Spell - Burn',
            description: 'For a number of hours equal to your Charm you can conjure and dispel an illusion that’s no larger than 5 yards in any dimension and is within 20 yards of you. Each round someone interacts with the illusion they can roll a “Perception” roll against your “Magic School: Creation” at the start of their turn. If they succeed they know it’s an illusion. If it’s something dangerous to them like fire, they take 1d3 damage at the start of their turn but roll their “Perception” with minor advantage.',
            level: 5
        }
    ],
    beasttamer: [
    ...
    faithful: [
        {
            ...
            action: 'Active - Spell ',
            description: 'Within 3 yards you create a barrier that is 3 yards wide. While in this barrier allies gain 3 points of damage resistance. Additionally all attacks made while in the barrier using “Magic School: Divine” have minor advantage.',
            level: 3
        },
        {
    ...
    swashbuckler: [
        {
            ...
            action: 'Triggered',
            description: 'Whenever you make a skill or attack roll and fail you gain a luck point. These can be spent to roll a skill or attack roll with major advantage. Your luck points reset to 0 after a rest and you can only have a maximum equal to your charm.',
            level: 3
        },
        {
            cardName:'Daring Deeds Indeed',
            action: 'Passive',
            description: 'Whenever you have more than 2 enemies adjacent to you or you’re flanked. You make all attacks with minor advantage and deal an extra +1d6 physical damage.',
            level: 3
        },
        {
    ...
    warlock: [
        {
            ...
            action: 'Active - Spell',
            description: 'Select 3 enemies within 6 yards that you can see, they roll “Toughness” against your “Magic School: Arcane” roll. If they fail they take 2d6 + your Intelligence Necrotic damage. If they have a condition caused by your Hex ability they also gain the Bleeding condition for a number of rounds equal to your Intelligence.',
            level: 3
        },
        {
            cardName:'Conjure Familiar',
            action: 'Active - Spell - Burn',
        ...
        },
        {
            ...
            action: 'Active - Spell - Burn',
            description: 'Pick 3 Allies within 4 yards. For a number rounds equal to your Intelligence whenever a coven member uses a character ability that makes them discard or burn a card, another member can allow them to use a card from their hand. Additionally If your Imp is in the coven its attacks deal an extra +1d3 necrotic damage and it can use your ‘Hex’ ability.',
            level: 5
        }
    ],
    wizard: [
